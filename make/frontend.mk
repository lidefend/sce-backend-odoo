...
verify.frontend.collection_view_semantics.browser: guard.prod.forbid environment.capability.inventory
	@SC_GOVERNED_BROWSER_ENTRY=1 node scripts/verify/collection_view_semantics_browser.mjs
