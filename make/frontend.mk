...
verify.frontend.ui5_scene_spike: guard.prod.forbid
	@python3 scripts/verify/frontend_ui5_scene_spike_guard.py
	@scripts/dev/pnpm_exec.sh -C frontend/apps/scene-ui5-spike build
...
.PHONY: verify.frontend.readonly_main_data_coverage.unit verify.frontend.create_default_hydration.unit verify.frontend.create_record_user_journey.unit
...
verify.frontend.quick.gate: verify.frontend.create_default_hydration.unit verify.frontend.create_record_user_journey.unit verify.frontend.native_collaboration_presentation.unit verify.frontend.cross_model_action_navigation.unit
