...
verify.product_form_list.requirements_v01: guard.prod.forbid
	@python3 -m unittest scripts/verify/test_product_form_list_requirements_v01.py
	@python3 scripts/verify/product_form_list_requirements_v01.py

verify.p1_master_data.capability_contract_v1: guard.prod.forbid
	@python3 scripts/verify/p1_master_data_capability_contract_v1.py

verify.p1_income_contract.capability_contract_v1: guard.prod.forbid
	@python3 scripts/verify/p1_income_contract_capability_contract_v1.py

verify.p1_material_inbound.capability_contract_v1: guard.prod.forbid
	@python3 scripts/verify/p1_material_inbound_capability_contract_v1.py
...
.PHONY: verify.frontend.action_view_route_lease_race.unit
verify.frontend.action_view_route_lease_race.unit: guard.prod.forbid
	@node scripts/verify/frontend_action_view_route_lease_race.test.mjs
