...
verify.business_config.unit: guard.prod.forbid verify.frontend.product_language.guard verify.business_config.product_guard verify.business_config.publish_boundary_guard
	...
	@node frontend/apps/web/scripts/designer_draft_ownership_test.mjs
	@node frontend/apps/web/scripts/designer_popup_readiness_test.mjs
...
verify.app_config_engine.boundary_guard: guard.prod.forbid
	...
	@python3 scripts/verify/test_app_config_engine_authority_guard.py
...
.PHONY: verify.frontend.contract_render_profile.unit
verify.frontend.contract_render_profile.unit: guard.prod.forbid
	@node scripts/verify/frontend_contract_render_profile.test.mjs
...
gate.full: guard.codex.fast.noheavy guard.prod.forbid check-compose-project check-compose-env
	...
	@$(MAKE) --no-print-directory gate.scene.inventory.hygiene.strict
