...
verify.frontend.dynamic_list_optional_columns.browser: guard.prod.forbid
	@BASE_URL="$${BASE_URL:-http://127.0.0.1:5175}" DB_NAME="$${DB_NAME:-sc_demo}" E2E_LOGIN="$${E2E_LOGIN:-wutao}" E2E_PASSWORD="$${E2E_PASSWORD:?E2E_PASSWORD is required}" ARTIFACTS_DIR="$${ARTIFACTS_DIR:-artifacts/frontend-dynamic-list-optional-columns}" DYNAMIC_LIST_TARGETS_JSON="$${DYNAMIC_LIST_TARGETS_JSON:-}" node scripts/verify/frontend_dynamic_list_optional_columns_browser.mjs
...
verify.frontend.release.unit: verify.frontend.localized_display.unit verify.frontend.list_optional_columns.unit verify.frontend.navigation_initialization_race.unit
