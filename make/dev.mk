...
local.dev.candidate.project_create_contract_action_scope: guard.prod.forbid local.dev.ready local.dev.candidate.frontend.health
	@$(LOCAL_ENV_ISOLATE) ENV=dev ENV_FILE="$(LOCAL_DEV_ENV_FILE)" ROOT_DIR="$(ROOT_DIR)" \
	  LOCAL_DEV_CANDIDATE_FRONTEND_BINDING=1 \
	  bash scripts/verify/local_dev_project_create_contract_action_scope.sh
