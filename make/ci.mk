...
.PHONY: verify.boq.export.capability
verify.boq.export.capability: guard.prod.forbid
	@python3 -m py_compile addons/smart_construction_core/services/boq_export_service.py addons/smart_construction_core/handlers/boq_export_request.py addons/smart_construction_core/tests/test_boq_export_request_handler.py
	@python3 addons/smart_construction_core/tests/test_boq_export_request_handler.py

.PHONY: verify.write.idempotency.capability
verify.write.idempotency.capability: guard.prod.forbid
	@python3 -m py_compile addons/smart_core/models/idempotency_record.py addons/smart_core/utils/idempotency.py addons/smart_core/utils/reason_codes.py addons/smart_construction_core/handlers/my_work_complete.py addons/smart_core/tests/test_write_idempotency_claim.py
...
.PHONY: verify.boq.line.patch.capability
verify.boq.line.patch.capability: guard.prod.forbid
	@python3 -m py_compile addons/smart_construction_core/services/boq_line_patch_service.py addons/smart_construction_core/handlers/boq_line_patch.py addons/smart_construction_core/core_extension_intent_handlers.py addons/smart_construction_core/tests/test_boq_line_patch_handler.py
	@python3 addons/smart_construction_core/tests/test_boq_line_patch_handler.py

.PHONY: verify.overview.rich.text.patch.capability
verify.overview.rich.text.patch.capability: guard.prod.forbid
	@python3 -m py_compile addons/smart_construction_core/services/overview_rich_text_patch_service.py addons/smart_construction_core/handlers/overview_rich_text_patch.py addons/smart_construction_core/core_extension_intent_handlers.py addons/smart_construction_core/tests/test_overview_rich_text_patch_handler.py addons/smart_construction_core/services/project_dashboard_builders/project_overview_builder.py addons/smart_construction_core/tests/test_project_overview_builder.py
	@python3 addons/smart_construction_core/tests/test_overview_rich_text_patch_handler.py
