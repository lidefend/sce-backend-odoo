...
test.chatter-timeline.authorization.orm: guard.prod.forbid
	@$(RUN_ENV) SC_AUTHORIZATION_ORM_TEST_TAGS=chatter_timeline_authorization_orm bash scripts/test/admin_vis_p3_project_record_rule_orm.sh
...
.PHONY: verify.frontend.professionalization.contract_domain.runtime
verify.frontend.professionalization.contract_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_contract_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_contract_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_contract_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_contract_domain_rollout
	@$(RUN_ENV) FRONTEND_CONTRACT_DOMAIN_ROLLOUT_PATH=/tmp/frontend_contract_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_contract_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_contract_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_contract_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_contract_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_contract_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/contract-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/contract-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.payment_domain.runtime
verify.frontend.professionalization.payment_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_payment_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_payment_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_payment_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_payment_domain_rollout
	@$(RUN_ENV) FRONTEND_PAYMENT_DOMAIN_ROLLOUT_PATH=/tmp/frontend_payment_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_payment_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_payment_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_payment_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_payment_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_payment_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/payment-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/payment-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.settlement_domain.runtime
verify.frontend.professionalization.settlement_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_settlement_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_settlement_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_settlement_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_settlement_domain_rollout
	@$(RUN_ENV) FRONTEND_SETTLEMENT_DOMAIN_ROLLOUT_PATH=/tmp/frontend_settlement_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_settlement_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_settlement_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_settlement_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_settlement_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_settlement_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/settlement-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/settlement-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.cost_domain.runtime
verify.frontend.professionalization.cost_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_cost_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_cost_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_cost_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_cost_domain_rollout
	@$(RUN_ENV) FRONTEND_COST_DOMAIN_ROLLOUT_PATH=/tmp/frontend_cost_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_cost_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_cost_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_cost_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_cost_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_cost_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/cost-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/cost-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.material_domain.runtime
verify.frontend.professionalization.material_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_material_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_material_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_material_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_material_domain_rollout
	@$(RUN_ENV) FRONTEND_MATERIAL_DOMAIN_ROLLOUT_PATH=/tmp/frontend_material_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_material_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_material_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_material_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_material_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_material_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/material-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/material-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.quality_safety_domain.runtime
verify.frontend.professionalization.quality_safety_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_quality_safety_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_quality_safety_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_quality_safety_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_quality_safety_domain_rollout
	@$(RUN_ENV) FRONTEND_QUALITY_SAFETY_DOMAIN_ROLLOUT_PATH=/tmp/frontend_quality_safety_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_quality_safety_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_quality_safety_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_quality_safety_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_quality_safety_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_quality_safety_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/quality-safety-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/quality-safety-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.collaboration_domain.runtime
verify.frontend.professionalization.collaboration_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_collaboration_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_collaboration_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_collaboration_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_collaboration_domain_rollout
	@$(RUN_ENV) FRONTEND_COLLABORATION_DOMAIN_ROLLOUT_PATH=/tmp/frontend_collaboration_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_collaboration_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_collaboration_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_collaboration_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_collaboration_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_collaboration_domain_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/collaboration-domain-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/collaboration-domain-coverage-v1.md

.PHONY: verify.frontend.professionalization.base_configuration_domain.runtime
verify.frontend.professionalization.base_configuration_domain.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_base_configuration_domain_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_base_configuration_domain_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_base_configuration_domain_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_base_configuration_domain_rollout
	@$(RUN_ENV) FRONTEND_BASE_CONFIGURATION_DOMAIN_ROLLOUT_PATH=/tmp/frontend_base_configuration_domain_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_base_configuration_domain_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_base_configuration_domain_rollout_v1.json artifacts/frontend-professionalization/frontend_base_configuration_domain_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_base_configuration_domain_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_base_configuration_domain_rollout_runtime_v1.json \
...
.PHONY: verify.frontend.professionalization.finance_center.runtime
verify.frontend.professionalization.finance_center.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_finance_center_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_finance_center_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_finance_center_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_finance_center_rollout
	@$(RUN_ENV) FRONTEND_FINANCE_CENTER_ROLLOUT_PATH=/tmp/frontend_finance_center_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_finance_center_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_finance_center_rollout_v1.json artifacts/frontend-professionalization/frontend_finance_center_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_finance_center_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_finance_center_rollout_runtime_v1.json \
...
.PHONY: verify.frontend.professionalization.accounting_center.runtime
verify.frontend.professionalization.accounting_center.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_accounting_center_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_accounting_center_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_accounting_center_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_accounting_center_rollout
	@$(RUN_ENV) FRONTEND_ACCOUNTING_CENTER_ROLLOUT_PATH=/tmp/frontend_accounting_center_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_accounting_center_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_accounting_center_rollout_v1.json artifacts/frontend-professionalization/frontend_accounting_center_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_accounting_center_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_accounting_center_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/accounting-center-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/accounting-center-coverage-v1.md

.PHONY: verify.frontend.professionalization.reporting_center.runtime
verify.frontend.professionalization.reporting_center.runtime: guard.prod.forbid check-compose-project check-compose-env
	@mkdir -p artifacts/frontend-professionalization docs/frontend_productization/domain-rollout
	@python3 -m py_compile scripts/verify/frontend_project_domain_rollout.py scripts/verify/frontend_reporting_center_rollout.py scripts/verify/frontend_project_domain_rollout_report.py scripts/verify/frontend_reporting_center_rollout_report.py scripts/verify/test_frontend_project_domain_rollout.py scripts/verify/test_frontend_reporting_center_rollout.py
	@python3 -m unittest scripts.verify.test_frontend_project_domain_rollout scripts.verify.test_frontend_reporting_center_rollout
	@$(RUN_ENV) FRONTEND_REPORTING_CENTER_ROLLOUT_PATH=/tmp/frontend_reporting_center_rollout_v1.json DB_NAME=$(DB_NAME) bash scripts/ops/odoo_shell_exec.sh < scripts/verify/frontend_reporting_center_rollout.py
	@$(RUN_ENV) $(COMPOSE_BASE) cp $(ODOO_SERVICE):/tmp/frontend_reporting_center_rollout_v1.json artifacts/frontend-professionalization/frontend_reporting_center_rollout_runtime_v1.json >/dev/null
	@python3 scripts/verify/frontend_reporting_center_rollout_report.py \
		--input artifacts/frontend-professionalization/frontend_reporting_center_rollout_runtime_v1.json \
		--json-output docs/frontend_productization/domain-rollout/reporting-center-coverage-v1.json \
		--markdown-output docs/frontend_productization/domain-rollout/reporting-center-coverage-v1.md
