...
.PHONY: verify.product.primary_center.baseline.guard verify.product.menu.contract_v1.guard verify.product.contract_center.wave1.guard verify.product.cost_center.wave1.guard verify.product.finance_center.wave1.guard verify.product.tax_center.wave1.guard verify.product.reporting_center.wave1.guard verify.product.administration_center.wave1.guard verify.product.menu.release_manifest_v2.guard verify.product.menu.release.ready
