    ...
    return _policy(
        [
            ...
            _section(
                "payment_accounts",
                "收付款账户",
                ["actual_payee_unit", "payment_account_name", "payment_bank_name", "payment_account_no", "payer_unit"],
                40,
            ),
            _section("handling", "办理说明", ["note"], 50),
            _section("evidence", "附件凭证", ["attachment_ids"], 55),
