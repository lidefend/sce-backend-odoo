...
_pre_DB_DATA="${DB_DATA:-}"
_pre_REDIS_DATA="${REDIS_DATA:-}"
_pre_ODOO_DATA="${ODOO_DATA:-}"
_pre_ODOO_DB="${ODOO_DB:-}"
_pre_ODOO_DBFILTER="${ODOO_DBFILTER:-}"
_pre_ODOO_PORT="${ODOO_PORT:-}"
_pre_ODOO_ARGS="${ODOO_ARGS:-}"
_pre_LIST_DB="${LIST_DB:-}"
_pre_MODULE="${MODULE:-}"
...
[[ -n "${_pre_DB_DATA}" ]] && DB_DATA="${_pre_DB_DATA}"
[[ -n "${_pre_REDIS_DATA}" ]] && REDIS_DATA="${_pre_REDIS_DATA}"
[[ -n "${_pre_ODOO_DATA}" ]] && ODOO_DATA="${_pre_ODOO_DATA}"
[[ -n "${_pre_ODOO_DB}" ]] && ODOO_DB="${_pre_ODOO_DB}"
[[ -n "${_pre_ODOO_DBFILTER}" ]] && ODOO_DBFILTER="${_pre_ODOO_DBFILTER}"
[[ -n "${_pre_ODOO_PORT}" ]] && ODOO_PORT="${_pre_ODOO_PORT}"
[[ -n "${_pre_ODOO_ARGS}" ]] && ODOO_ARGS="${_pre_ODOO_ARGS}"
[[ -n "${_pre_LIST_DB}" ]] && LIST_DB="${_pre_LIST_DB}"
