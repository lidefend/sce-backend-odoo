#!/usr/bin/env python3
"""Audit the formal settlement frontend rollout from runtime authority."""
...
OUTPUT_PATH = Path(
    os.getenv(
        "FRONTEND_SETTLEMENT_DOMAIN_ROLLOUT_PATH",
        "/tmp/frontend_settlement_domain_rollout_v1.json",
    )
)
EXPECTED_ANCHORS = {
