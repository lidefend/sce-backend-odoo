#!/usr/bin/env python3
"""Create deterministic checked-in tax-center rollout evidence."""
...
def main() -> int:
    ...
    Path(args.markdown_output).write_text(_SHARED.markdown(payload, "Tax Center Frontend Rollout v1"), encoding="utf-8")
