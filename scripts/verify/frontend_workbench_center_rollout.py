#!/usr/bin/env python3
"""Audit the formal workbench-center frontend rollout from runtime authority."""
...
ROOT_MENU_XMLIDS = ("smart_construction_core.menu_sc_workspace_center",)
OWNER_MODULE = "smart_construction_core"
OUTPUT_PATH = Path(os.getenv(
    "FRONTEND_WORKBENCH_CENTER_ROLLOUT_PATH",
    "/tmp/frontend_workbench_center_rollout_v1.json",
))
EXPECTED_ANCHORS = {
    "smart_construction_core.action_sc_operating_metrics_project",
    "smart_construction_core.action_project_dashboard",
    "smart_construction_core.action_sc_workbench_task_center",
