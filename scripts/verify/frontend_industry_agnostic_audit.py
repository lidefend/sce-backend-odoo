...
FORBIDDEN_ASSETS = {
    ...
    "frontend/apps/web/src/components/role-home/WorkspaceHome.vue": "首页必须由通用工作空间契约渲染。",
    "frontend/apps/web/src/composables/shared-surface/useWorkspaceHome.ts": "首页 composable 不得携带业务产品命名或推断。",
