...
CANDIDATE_VISUAL_DESKTOP_WIDTH="${CANDIDATE_VISUAL_DESKTOP_WIDTH:-1440}" \
CANDIDATE_VISUAL_DESKTOP_HEIGHT="${CANDIDATE_VISUAL_DESKTOP_HEIGHT:-960}" \
CANDIDATE_VISUAL_MOBILE_WIDTH="${CANDIDATE_VISUAL_MOBILE_WIDTH:-390}" \
CANDIDATE_VISUAL_THEME="${CANDIDATE_VISUAL_THEME:-light}" \
CANDIDATE_VISUAL_OUTPUT_DIR="${CANDIDATE_VISUAL_OUTPUT_DIR:-artifacts/playwright/local-dev-candidate-visual-smoke}" \
