...
class TestLocalDevTenderAwardFixture(unittest.TestCase):
    ...
    def test_browser_binds_product_and_tool_candidates_and_uses_formal_entry(self):
        ...
        self.assertIn("repeatRequest", BROWSER)
        self.assertIn("postIntent(page, repeatRequest, true)", BROWSER)
        ...
        self.assertIn("award_opening_descriptors", BROWSER)
        self.assertIn("page.getByText(label, { exact: true })", BROWSER)
