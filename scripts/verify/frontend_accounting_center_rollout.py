#!/usr/bin/env python3
"""Audit the formal accounting-center frontend rollout from runtime authority."""
...
DOMAIN_KEY = "accounting_center"
ROOT_MENU_XMLIDS = ("smart_construction_core.menu_sc_accounting_center",)
OWNER_MODULE = "smart_construction_core"
OUTPUT_PATH = Path(os.getenv("FRONTEND_ACCOUNTING_CENTER_ROLLOUT_PATH", "/tmp/frontend_accounting_center_rollout_v1.json"))
EXPECTED_ANCHORS = {
    "smart_construction_core.action_sc_account_journal_foundation",
    "smart_construction_core.action_sc_analytic_account_foundation",
    "smart_construction_core.action_sc_analytic_distribution_foundation",
}
