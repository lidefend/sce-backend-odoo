...
payload = {
    ...
    "journey_request": target("smart_construction_core.menu_sc_user_payment_apply", "smart_construction_acceptance_fixture.fe_delivery_hardening_payment_request_a"),
