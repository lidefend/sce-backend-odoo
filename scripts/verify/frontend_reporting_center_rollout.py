#!/usr/bin/env python3
"""Audit the formal reporting-center frontend rollout from runtime authority."""
...
DOMAIN_KEY = "reporting_center"
ROOT_MENU_XMLIDS = ("smart_construction_core.menu_sc_data_center",)
OWNER_MODULE = "smart_construction_core"
OUTPUT_PATH = Path(os.getenv("FRONTEND_REPORTING_CENTER_ROLLOUT_PATH", "/tmp/frontend_reporting_center_rollout_v1.json"))
EXPECTED_ANCHORS = {
    "smart_construction_core.action_sc_project_operation_statistics_report",
    "smart_construction_core.action_sc_legacy_business_entity_map",
    "smart_construction_core.action_sc_comprehensive_cost_statistics_report",
    "smart_construction_core.action_sc_fund_daily_summary",
    "smart_construction_core.action_sc_product_tax_report_v1",
    "smart_construction_core.action_sc_product_labor_subcontract_report_v1",
}
