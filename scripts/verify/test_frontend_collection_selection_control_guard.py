...
from scripts.verify.frontend_collection_selection_control_guard import CONTROL, CONTROL_CSS, LIST_PAGE, validate
...
class CollectionSelectionControlGuardTest(unittest.TestCase):
    ...
    def test_repository_contract_passes(self):
        self.assertEqual(validate(self.list_source, self.control_source, self.css_source), [])
