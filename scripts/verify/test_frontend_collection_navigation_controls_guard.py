...
from scripts.verify.frontend_collection_navigation_controls_guard import COMPONENT, LIST_PAGE, validate
...
class CollectionNavigationControlsGuardTest(unittest.TestCase):
    ...
    def test_repository_contract_passes(self):
        self.assertEqual(validate(self.component, self.list_page), [])
