...
RELEASED_MENU_BINDINGS = (
    ...
    ("项目中心", "招标信息", "smart_construction_core.menu_sc_product_tender_information_v1", "smart_construction_core.action_sc_product_tender_information_v1", "tender.bid", ("招投标管理", "招标信息")),
    ("项目中心", "投标项目", "smart_construction_core.menu_sc_project_tender", "smart_construction_core.action_tender_bid", "tender.bid", ("招投标管理", "投标项目")),
    ("项目中心", "标书管理", "smart_construction_core.menu_sc_product_tender_document_v1", "smart_construction_core.action_sc_product_tender_document_v1", "tender.doc.purchase", ("招投标管理", "标书管理")),
    ...
    ("项目中心", "劳务实名制", "smart_construction_core.menu_sc_product_labor_realname_v1", "smart_construction_core.action_sc_product_labor_realname_v1", "sc.attendance.checkin", ("劳务成本", "劳务实名制")),
    ...
    ("项目中心", "劳务扣款明细", "smart_construction_core.menu_sc_product_labor_deduction_v1", "smart_construction_core.action_sc_product_labor_deduction_v1", "sc.expense.claim", ("劳务成本", "劳务扣款明细")),
