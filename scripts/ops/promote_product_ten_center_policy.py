...
RELEASED_MENU_BINDINGS = (
    ...
    ("项目中心", "签证变更", "smart_construction_core.menu_sc_product_site_variation_v1", "smart_construction_core.action_sc_product_site_variation_v1", "sc.site.variation", ("施工管理", "签证变更")),
    ...
    ("项目中心", "班组借/扣款登记", "smart_construction_core.menu_sc_product_team_loan_deduction_v1", "smart_construction_core.action_sc_product_team_loan_deduction_v1", "sc.team.loan.deduction.workspace", ("班组借/扣款", "班组借/扣款登记")),
    ...
    ("合同中心", "合同变更", "smart_construction_core.menu_sc_p1_contract_change", "smart_construction_core.action_sc_contract_change", "sc.contract.change", ("合同变更",)),
    ...
    ("报表中心", "税务报表", "smart_construction_core.menu_sc_product_tax_report_v1", "smart_construction_core.action_sc_product_tax_report_v1", "sc.tax.filing", ("税务报表",)),
    ("报表中心", "劳务分包报表", "smart_construction_core.menu_sc_product_labor_subcontract_report_v1", "smart_construction_core.action_sc_product_labor_subcontract_report_v1", "sc.labor.subcontract.report", ("劳务分包报表",)),
    ...
    ("产品配置", "数据权限", "smart_construction_core.menu_sc_product_data_permission_v1", "smart_construction_core.action_sc_product_data_permission_v1", "res.users", ("数据权限",)),
    ...
    ("产品配置", "编码规则", "smart_construction_core.menu_sc_product_numbering_rule_v1", "smart_construction_core.action_sc_product_numbering_rule_v1", "ir.sequence", ("编码规则",)),
)
