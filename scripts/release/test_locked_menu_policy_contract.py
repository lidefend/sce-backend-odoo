...
class LockedMenuPolicyContractTests(unittest.TestCase):
    ...
    def test_versioned_locked_baseline_loads_and_contains_expected_contract(self):
        ...
        self.assertEqual(
            contract["sha256"],
            "6f0d7daa6f31e4bab1ec4ca409abb087fe727ff032a6969d7172489729907163",
        )
    ...
    def test_policy_comparison_uses_stable_identity_not_database_ids(self):
        ...
        self.assertEqual(result["menu_count"], 150)
    ...
    def test_standard_and_preview_contracts_are_independent_objects(self):
        ...
        self.assertEqual(len(CONTRACT.baseline_rows(contract, "construction.standard")), 150)
        self.assertEqual(len(CONTRACT.baseline_rows(contract, "construction.preview")), 150)
