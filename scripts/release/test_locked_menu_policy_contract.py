...
class LockedMenuPolicyContractTests(unittest.TestCase):
    ...
    def test_versioned_locked_baseline_loads_and_contains_expected_contract(self):
        ...
        self.assertEqual(
            contract["sha256"],
            "28f021c3be9f09c4b430efdea9d5fd75a881d7bf381e86b1eba570339e5ca231",
        )
    ...
    def test_policy_comparison_uses_stable_identity_not_database_ids(self):
        ...
        self.assertEqual(result["menu_count"], 159)
    ...
    def test_standard_and_preview_contracts_are_independent_objects(self):
        ...
        self.assertEqual(len(CONTRACT.baseline_rows(contract, "construction.standard")), 159)
        self.assertEqual(len(CONTRACT.baseline_rows(contract, "construction.preview")), 159)
