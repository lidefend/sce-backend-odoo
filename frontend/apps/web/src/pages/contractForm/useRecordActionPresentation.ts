...
export function useRecordActionPresentation(dependencies: PresentationDependencies) {
  ...
  const {
    ...
    validationErrors, validationFieldErrors, isIntakeCreateMode, intentConfirmationRef, formConflict,
  ...
  const relationFieldAdapter = computed<RelationFieldAdapter>(() => ({
    ...
    one2manyRowErrors,
    one2manyCellError: dependencies.one2manyCellError,
    one2manyRowHints,
    removedOne2manyRows,
    restoreOne2manyRow,
    one2manyRowLabel,
