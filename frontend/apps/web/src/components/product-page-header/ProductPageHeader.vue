...
@media(max-width:1200px){.product-page-header--task,.product-page-header--workspace{align-items:stretch;flex-direction:column}.product-page-header--task .product-page-header__identity,.product-page-header--workspace .product-page-header__identity{flex:0 1 auto;min-width:0}.product-page-header--task .product-page-header__status,.product-page-header--workspace .product-page-header__status{width:100%;max-width:none;margin-left:0;text-align:left}.product-page-header--task .product-page-header__actions,.product-page-header--workspace .product-page-header__actions{width:100%}}
