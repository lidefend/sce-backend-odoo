...
const props = withDefaults(defineProps<{
  name: 'apps' | 'arrow-left' | 'arrow-right' | 'bell' | 'briefcase' | 'building' | 'chevron-right' | 'close' | 'columns' | 'folder' | 'home' | 'menu' | 'panel-left' | 'plus' | 'search' | 'settings' | 'star' | 'star-outline' | 'sun' | 'user';
  size?: 14 | 16 | 18 | 20 | 24;
}>(), { size: 20 });
