...
withDefaults(defineProps<{ label: string; disabled?: boolean; appearance?: 'default' | 'toolbar-menu-toggle' | 'favorite-toggle' | 'outline-action' | 'column-handle' | 'activity-rail' | 'activity-tab-close' }>(), {
  appearance: 'default',
});
