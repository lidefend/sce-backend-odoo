...
.list-surface-column-menu { position: absolute; z-index: 40; right: 0; top: calc(100% + var(--sc-space-2xs)); display: grid; gap: var(--sc-space-2xs); min-width: 210px; max-height: min(320px, 70vh); overflow: auto; border: 1px solid var(--sc-app-info-border); border-radius: var(--sc-product-radius-panel); background: var(--sc-app-panel); padding: var(--sc-space-xs); box-shadow: var(--sc-product-shadow-overlay); }
...
.list-surface-column-reset { min-height: 40px; margin-top: var(--sc-space-2xs); border: 1px solid var(--sc-app-info-border); border-radius: var(--sc-product-radius-panel); background: var(--sc-app-muted-bg); color: var(--sc-app-info-text); cursor: pointer; }
