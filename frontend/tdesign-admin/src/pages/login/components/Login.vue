<template>
  ...
  >
    <template v-if="type === 'password'">
      <t-form-item name="account">
        <t-input
          ...
          size="large"
          :placeholder="`${t('pages.login.input.account')}：sc_test_admin`"
        >
      ...
      <div class="check-container remember-pwd">
        ...
        <router-link class="tip" to="/password-recovery">{{ t('pages.login.forget') }}</router-link>
      </div>
    </template>
    ...
    <div class="switch-container">
      <router-link class="tip" to="/activate-account">激活账号</router-link>
