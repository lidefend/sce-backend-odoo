...
| File | Before | After |
| --- | ---: | ---: |
| `frontend/apps/web/src/pages/ContractFormPage.vue` | 13762 | 1787 |
...
- `ContractFormPage.vue` is line-count locked at 1787 lines. Future work must continue extracting or modifying existing owned modules instead of adding new responsibilities to the route component.
