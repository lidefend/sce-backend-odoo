...
| 4197 | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
...
| 1241 | Python source | `addons/smart_construction_acceptance_fixture/tools/frontend_productization_fixture.py` |
...
| 4197 | split_plan_required | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
...
| 1241 | warning | Python source | `addons/smart_construction_acceptance_fixture/tools/frontend_productization_fixture.py` |
