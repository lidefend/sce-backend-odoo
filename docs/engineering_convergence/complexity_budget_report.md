...
- Files above warning threshold: `82`

## Split Plan Required

| Lines | Category | File |
| ---: | --- | --- |
| 4670 | Python source | `addons/smart_core/core/unified_page_contract_v2_assembler.py` |
| 4565 | Python source | `addons/smart_core/tests/test_ui_contract_v2_boundaries.py` |
| 4294 | Python source | `addons/smart_core/handlers/ui_contract_v2.py` |
| 4188 | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
| 3693 | Python source | `addons/smart_core/tests/test_unified_page_contract_v2_mobile_compact.py` |
...
| 3262 | Python source | `addons/smart_construction_core/models/core/material_acceptance.py` |
| 3234 | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 2510 | Python source | `addons/smart_construction_core/tests/test_user_feedback_business_views.py` |
| 2464 | Python source | `addons/smart_core/handlers/api_data.py` |
| 2442 | Python source | `addons/smart_core/handlers/system_init.py` |
| 2420 | Python source | `addons/smart_core/delivery/menu_service.py` |
...
| 2048 | Vue source | `frontend/apps/web/src/pages/ListPage.vue` |
...
| 1847 | Python source | `addons/smart_construction_core/tests/test_p1_finance_projection_authority.py` |
...
| 1381 | Python source | `addons/smart_core/tests/test_delivery_menu_entry_target.py` |
...
| 1240 | Vue source | `frontend/apps/web/src/components/template/FormSection.vue` |
| 1237 | JavaScript source | `scripts/verify/local_dev_candidate_visual_smoke.mjs` |
| 1234 | Python source | `addons/smart_construction_core/models/core/payment_execution.py` |
...
| 1133 | Vue source | `frontend/apps/web/src/components/template/NativeFormTreeRenderer.vue` |
...
| 949 | Python source | `addons/smart_construction_core/tests/test_cost_fact_model_v2.py` |
...
| ---: | --- | --- | --- |
| 4670 | split_plan_required | Python source | `addons/smart_core/core/unified_page_contract_v2_assembler.py` |
| 4565 | split_plan_required | Python source | `addons/smart_core/tests/test_ui_contract_v2_boundaries.py` |
| 4294 | split_plan_required | Python source | `addons/smart_core/handlers/ui_contract_v2.py` |
| 4188 | split_plan_required | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
| 3693 | split_plan_required | Python source | `addons/smart_core/tests/test_unified_page_contract_v2_mobile_compact.py` |
...
| 3262 | split_plan_required | Python source | `addons/smart_construction_core/models/core/material_acceptance.py` |
| 3234 | split_plan_required | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 2510 | split_plan_required | Python source | `addons/smart_construction_core/tests/test_user_feedback_business_views.py` |
...
| 2420 | split_plan_required | Python source | `addons/smart_core/delivery/menu_service.py` |
...
| 2048 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ListPage.vue` |
...
| 1847 | split_plan_required | Python source | `addons/smart_construction_core/tests/test_p1_finance_projection_authority.py` |
...
| 1381 | warning | Python source | `addons/smart_core/tests/test_delivery_menu_entry_target.py` |
...
| 1240 | warning | Vue source | `frontend/apps/web/src/components/template/FormSection.vue` |
| 1237 | warning | JavaScript source | `scripts/verify/local_dev_candidate_visual_smoke.mjs` |
| 1234 | warning | Python source | `addons/smart_construction_core/models/core/payment_execution.py` |
...
| 1133 | warning | Vue source | `frontend/apps/web/src/components/template/NativeFormTreeRenderer.vue` |
