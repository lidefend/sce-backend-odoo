...
| 4178 | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
...
| 1094 | JavaScript source | `scripts/verify/frontend_delivery_hardening_browser.mjs` |
...
| 440 | Shell script | `scripts/dev/frontend_acceptance_runtime.sh` |
...
| 4178 | split_plan_required | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
...
| 1094 | warning | JavaScript source | `scripts/verify/frontend_delivery_hardening_browser.mjs` |
