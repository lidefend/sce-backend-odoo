...
| 2457 | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 1788 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| 1552 | Python source | `addons/smart_construction_core/tests/test_p1_payment_request_capability.py` |
...
| 989 | JavaScript source | `scripts/verify/pfl035_payment_request_runtime_acceptance.mjs` |
...
| 2457 | split_plan_required | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 1788 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| 1552 | split_plan_required | Python source | `addons/smart_construction_core/tests/test_p1_payment_request_capability.py` |
