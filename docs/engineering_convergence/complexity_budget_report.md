...
- Files above warning threshold: `90`

## Split Plan Required

| Lines | Category | File |
| ---: | --- | --- |
| 4733 | Python source | `addons/smart_core/core/unified_page_contract_v2_assembler.py` |
| 4665 | Python source | `addons/smart_core/tests/test_ui_contract_v2_boundaries.py` |
| 4550 | JavaScript source | `scripts/verify/local_dev_candidate_visual_smoke.mjs` |
| 4311 | Python source | `addons/smart_core/handlers/ui_contract_v2.py` |
| 4221 | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
| 3803 | Python source | `addons/smart_core/tests/test_unified_page_contract_v2_mobile_compact.py` |
...
| 3250 | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 1759 | Python source | `addons/smart_core/app_config_engine/services/view_Parser/parsers Tree Form.py` |
...
| 1235 | Vue source | `frontend/apps/web/src/components/template/NativeFormTreeRenderer.vue` |
| 1234 | TypeScript source | `frontend/apps/web/src/pages/contractForm/nativeLayoutUtils.ts` |
...
| 1141 | Python source | `addons/smart_construction_core/models/support/business_form_policy_templates.py` |
...
| 997 | Python source | `addons/smart_construction_core/tests/test_core_extension_v2_finalize.py` |
...
| 808 | Python source | `addons/smart_core/tests/test_page_assembler_view_orchestration_versions.py` |
...
| ---: | --- | --- | --- |
| 4733 | split_plan_required | Python source | `addons/smart_core/core/unified_page_contract_v2_assembler.py` |
| 4665 | split_plan_required | Python source | `addons/smart_core/tests/test_ui_contract_v2_boundaries.py` |
| 4550 | split_plan_required | JavaScript source | `scripts/verify/local_dev_candidate_visual_smoke.mjs` |
| 4311 | split_plan_required | Python source | `addons/smart_core/handlers/ui_contract_v2.py` |
| 4221 | split_plan_required | Python source | `addons/smart_core/app_config_engine/services/assemblers/page_assembler.py` |
| 3803 | split_plan_required | Python source | `addons/smart_core/tests/test_unified_page_contract_v2_mobile_compact.py` |
...
| 3250 | split_plan_required | Python source | `addons/smart_construction_core/models/core/payment_request.py` |
...
| 1759 | split_plan_required | Python source | `addons/smart_core/app_config_engine/services/view_Parser/parsers Tree Form.py` |
...
| 1235 | warning | Vue source | `frontend/apps/web/src/components/template/NativeFormTreeRenderer.vue` |
| 1234 | warning | TypeScript source | `frontend/apps/web/src/pages/contractForm/nativeLayoutUtils.ts` |
...
| 1141 | warning | Python source | `addons/smart_construction_core/models/support/business_form_policy_templates.py` |
