...
| 1244 | Python source | `addons/smart_construction_core/tests/test_p1_payment_request_capability.py` |
...
| 987 | Python source | `addons/smart_construction_core/models/support/business_form_policy_templates.py` |
...
| 854 | JavaScript source | `scripts/verify/pfl035_payment_request_runtime_acceptance.mjs` |
...
| 1244 | warning | Python source | `addons/smart_construction_core/tests/test_p1_payment_request_capability.py` |
...
| 987 | warning | Python source | `addons/smart_construction_core/models/support/business_form_policy_templates.py` |
