...
| 1792 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| 998 | JavaScript source | `scripts/verify/pfl035_payment_request_runtime_acceptance.mjs` |
...
| 1792 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| 998 | warning | JavaScript source | `scripts/verify/pfl035_payment_request_runtime_acceptance.mjs` |
