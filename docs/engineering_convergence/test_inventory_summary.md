...
| Disposition | Count |
| --- | ---: |
| deduplicate_before_required | 895 |
...
| `scripts/verify/test_frontend_collection` | 6 |
...
| `scripts/verify/test_frontend_collection` | 6 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
