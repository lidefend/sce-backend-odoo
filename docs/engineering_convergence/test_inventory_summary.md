...
| Disposition | Count |
| --- | ---: |
| deduplicate_before_required | 968 |
...
| --- | --- | --- | --- |
| T-ASSET-060 | unit | `scripts/diag/fe_smoke.sh` | status=review |
| T-ASSET-061 | unit | `scripts/diag/test-default-menu.py` | status=review |
| T-ASSET-062 | unit | `scripts/diag/test-frontend-changes.sh` | status=review |
| T-ASSET-063 | unit | `scripts/diag/test-menu-issue.sh` | status=review |

## Unknown Runtime Assets

| ID | Layer | Entrypoint |
| --- | --- | --- |
| T-ASSET-060 | unit | `scripts/diag/fe_smoke.sh` |
| T-ASSET-062 | unit | `scripts/diag/test-frontend-changes.sh` |
| T-ASSET-063 | unit | `scripts/diag/test-menu-issue.sh` |

## PR Dedupe Candidate Sample

| ID | Layer | Entrypoint | Owner |
| --- | --- | --- | --- |
| T-ASSET-001 | frontend_acceptance | `frontend/apps/web/scripts/business_config_draft_scope_race_test.mjs` | frontend owner |
...
| T-ASSET-009 | frontend_acceptance | `frontend/apps/web/scripts/frontend_core_journeys_audit.mjs` | frontend owner |
| T-ASSET-010 | frontend_acceptance | `frontend/apps/web/scripts/frontend_product_baseline_guard.mjs` | frontend owner |
| T-ASSET-011 | frontend_acceptance | `frontend/apps/web/scripts/frontend_product_maturity_audit.mjs` | frontend owner |
| T-ASSET-012 | security | `frontend/apps/web/scripts/frontend_role_journey_audit.mjs` | security owner |
| T-ASSET-013 | frontend_acceptance | `frontend/apps/web/scripts/handling_entry_catalog_smoke.mjs` | frontend owner |
| T-ASSET-014 | contract | `frontend/apps/web/scripts/list_selection_contract_smoke.mjs` | platform owner |
| T-ASSET-015 | frontend_acceptance | `frontend/apps/web/scripts/low_code_business_config_acceptance.mjs` | frontend owner |
| T-ASSET-016 | frontend_acceptance | `frontend/apps/web/scripts/low_code_change_set_acceptance.mjs` | frontend owner |
| T-ASSET-017 | frontend_acceptance | `frontend/apps/web/scripts/low_code_form_group_matrix_acceptance.mjs` | frontend owner |
| T-ASSET-020 | frontend_acceptance | `frontend/apps/web/scripts/low_code_global_stability_acceptance.mjs` | frontend owner |
| T-ASSET-021 | frontend_acceptance | `frontend/apps/web/scripts/low_code_menu_navigation_alignment_acceptance.mjs` | frontend owner |
| T-ASSET-022 | frontend_acceptance | `frontend/apps/web/scripts/low_code_safe_open_acceptance.mjs` | frontend owner |
| T-ASSET-023 | frontend_acceptance | `frontend/apps/web/scripts/low_code_workbench_fault_acceptance.mjs` | frontend owner |
| T-ASSET-024 | frontend_acceptance | `frontend/apps/web/scripts/low_code_workbench_product_acceptance.mjs` | frontend owner |
| T-ASSET-025 | frontend_acceptance | `frontend/apps/web/scripts/product_navigation_boundary_acceptance.mjs` | frontend owner |
| T-ASSET-026 | frontend_acceptance | `frontend/apps/web/scripts/product_page_structure_guard.mjs` | frontend owner |
| T-ASSET-030 | frontend_acceptance | `frontend/apps/web/scripts/user_visible_surface_visual_coverage_summary_guard.mjs` | frontend owner |
| T-ASSET-031 | governance | `scripts/audit/boundary_audit_smart_core.py` | architecture owner |
| T-ASSET-032 | governance | `scripts/audit/scene_config_audit.js` | architecture owner |
| T-ASSET-035 | unit | `scripts/audit/test_generate_frontend_component_driver_takeover_inventory.py` | test owner |
| T-ASSET-036 | unit | `scripts/audit/test_generate_frontend_official_design_alignment_inventory.py` | test owner |
| T-ASSET-037 | unit | `scripts/audit/test_generate_frontend_professionalization_baseline.py` | test owner |
| T-ASSET-038 | unit | `scripts/audit/test_generate_frontend_rendering_detail_inventory.py` | test owner |
| T-ASSET-039 | unit | `scripts/audit/test_generate_frontend_visual_projection_inventory.py` | test owner |
| T-ASSET-040 | governance | `scripts/ci/assert_audit_tp08.py` | architecture owner |
| T-ASSET-041 | contract | `scripts/ci/enforce_contract_structure_lock.py` | platform owner |
| T-ASSET-043 | governance | `scripts/ci/frontend_professional_extension_guard.py` | architecture owner |
| T-ASSET-044 | governance | `scripts/ci/gate_audit.sh` | architecture owner |
| T-ASSET-045 | governance | `scripts/ci/gate_audit_tp08.sh` | architecture owner |
| T-ASSET-046 | contract | `scripts/ci/generate_contract_structure_fingerprint.py` | platform owner |
| T-ASSET-047 | unit | `scripts/ci/generate_e2e_journey_matrix.py` | test owner |
| T-ASSET-048 | unit | `scripts/ci/generate_test_inventory.py` | test owner |
| T-ASSET-049 | unit | `scripts/ci/summarize_test_inventory.py` | test owner |
| T-ASSET-050 | contract | `scripts/ci/test_backend_test_suite_dispatch_contract.py` | platform owner |
| T-ASSET-051 | unit | `scripts/ci/test_ci_risk_classifier.py` | test owner |
| T-ASSET-052 | contract | `scripts/ci/test_ci_risk_workflow_contract.py` | platform owner |
| T-ASSET-053 | governance | `scripts/ci/test_frontend_professional_extension_guard.py` | architecture owner |
| T-ASSET-054 | unit | `scripts/ci/test_merge_policy_gate.py` | test owner |
| T-ASSET-055 | unit | `scripts/ci/test_personal_data_scan.py` | test owner |
| T-ASSET-056 | unit | `scripts/ci/test_release_candidate_gate.py` | test owner |
| T-ASSET-057 | unit | `scripts/ci/test_secret_scan.py` | test owner |
| T-ASSET-058 | security | `scripts/ci/test_select_authoritative_workflow_run.py` | security owner |
| T-ASSET-059 | contract | `scripts/ci/verify_contract_form_split_evidence.py` | platform owner |
| T-ASSET-072 | contract | `scripts/ops/contract_product_acceptance_policy_restore.py` | platform owner |
| T-ASSET-079 | contract | `scripts/ops/formal_list_surface_test_contract_cleanup.py` | platform owner |
| T-ASSET-084 | contract | `scripts/ops/operation_strategy_contract_surface_backfill.py` | platform owner |
| T-ASSET-093 | contract | `scripts/ops/settlement_contract_surface_backfill.py` | platform owner |
| T-ASSET-130 | contract | `scripts/ops/validate_contract_business_categories.sh` | platform owner |
| T-ASSET-141 | contract | `scripts/verify/action_default_group_contract_audit.py` | platform owner |
| T-ASSET-142 | governance | `scripts/verify/action_surface_renderer_architecture_guard.py` | architecture owner |
| T-ASSET-143 | contract | `scripts/verify/action_view_contract_action_runtime_smoke.js` | platform owner |
| T-ASSET-144 | contract | `scripts/verify/action_view_orchestration_contract_shape_smoke.js` | platform owner |
| T-ASSET-145 | governance | `scripts/verify/action_view_responsibility_map_guard.py` | architecture owner |
| T-ASSET-147 | governance | `scripts/verify/agent_context_verify.py` | architecture owner |
| T-ASSET-148 | governance | `scripts/verify/app_config_engine_boundary_guard.py` | architecture owner |
| T-ASSET-149 | governance | `scripts/verify/application_form_required_marker_audit.py` | architecture owner |
| T-ASSET-152 | security | `scripts/verify/auth_credential_frontend_guard.py` | security owner |
| T-ASSET-153 | unit | `scripts/verify/auto_degrade_smoke_report.py` | test owner |
| T-ASSET-157 | governance | `scripts/verify/backend_boundary_guard.py` | architecture owner |
| T-ASSET-158 | governance | `scripts/verify/backend_business_fact_model_audit.py` | architecture owner |
| T-ASSET-159 | contract | `scripts/verify/backend_contract_boundary_guard.py` | platform owner |
| T-ASSET-165 | contract | `scripts/verify/backend_contract_lifecycle_authority_guard.py` | platform owner |
| T-ASSET-166 | contract | `scripts/verify/backend_contract_lifecycle_migration_rehearsal_prepare.py` | platform owner |
| T-ASSET-167 | contract | `scripts/verify/backend_contract_lifecycle_runtime_probe.py` | platform owner |
| T-ASSET-170 | governance | `scripts/verify/baseline_freeze_guard.py` | architecture owner |
| T-ASSET-171 | governance | `scripts/verify/baseline_iteration_execution_policy_guard.py` | architecture owner |
| T-ASSET-172 | governance | `scripts/verify/baseline_policy_integrity_guard.py` | architecture owner |
| T-ASSET-175 | security | `scripts/verify/boq_dual_role_five_viewport_evidence_guard.py` | security owner |
| T-ASSET-179 | governance | `scripts/verify/branch_governance_consistency_guard.py` | architecture owner |
| T-ASSET-180 | unit | `scripts/verify/build_norm_engine_acceptance_fixture.py` | test owner |
| T-ASSET-181 | governance | `scripts/verify/business_action_coverage_audit.py` | architecture owner |
| T-ASSET-184 | governance | `scripts/verify/business_category_dictionary_audit.py` | architecture owner |
| T-ASSET-186 | contract | `scripts/verify/business_config_contract_snapshot.py` | platform owner |
| T-ASSET-187 | unit | `scripts/verify/business_config_form_layout_acceptance.js` | test owner |
| T-ASSET-188 | governance | `scripts/verify/business_config_guard_inventory.py` | architecture owner |
| T-ASSET-190 | governance | `scripts/verify/business_config_user_language_guard.py` | architecture owner |
| T-ASSET-191 | governance | `scripts/verify/business_core_journey_guard.py` | architecture owner |
| ... | ... | 888 more | ... |
...
| `scripts/verify/test_frontend_collection` | 9 |
| `scripts/verify/test_frontend_professional` | 9 |
...
| `scripts/verify/test_frontend_collection` | 9 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
| `scripts/verify/test_frontend_professional` | 9 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
...
| `scripts/verify/frontend_professional_relation` | 2 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
| `scripts/verify/frontend_systemwide_coverage` | 2 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
