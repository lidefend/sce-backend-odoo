...
| Disposition | Count |
| --- | ---: |
| deduplicate_before_required | 849 |
...
| `scripts/verify/test_frontend_professional` | 4 |
...
| `scripts/verify/test_frontend_professional` | 4 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
