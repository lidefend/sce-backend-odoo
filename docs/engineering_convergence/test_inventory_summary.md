...
| `scripts/verify/test_frontend_release` | 4 |
...
| `scripts/verify/test_frontend_release` | 4 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
