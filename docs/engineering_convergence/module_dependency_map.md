...
- External Odoo dependency references: `21`
...
| --- | --- | --- | --- | --- | --- | --- |
| `sc_norm_engine` | 17.0.1.4.2 | yes | no | smart_construction_core | uom | - |
...
| `smart_construction_core` | 17.0.0.131 | yes | yes | smart_core | account, auth_signup, base_tier_validation, base_tier_validation_server_action, hr, mail, product, project, purchase, purchase_stock, stock, uom, web | sc_norm_engine, smart_construction_bundle, smart_construction_demo, smart_construction_portal, smart_construction_scene, smart_construction_seed |
| `smart_construction_demo` | 0.3.0 | yes | no | smart_construction_bundle, smart_construction_core, smart_construction_seed | account | - |
...
| `smart_construction_seed` | 17.0.0.2.2 | yes | no | smart_construction_bootstrap, smart_construction_core | account | smart_construction_demo |
| `smart_core` | 17.0.1.1.10 | yes | no | - | base, web | smart_construction_bundle, smart_construction_core, smart_license_core, smart_owner_bundle, smart_owner_core, smart_scene |
