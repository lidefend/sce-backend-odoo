...
This batch owns money, percentage, status, and duration presentation for task/workspace and create/edit/readonly. It does not own relation creation, relation dialogs, workflow transitions, business-model policies, or domain-specific labels.
